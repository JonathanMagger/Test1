...
public class App8 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Selecting Particular Records of given table by like operator... ");
			...
			//Select all records firstname contain ef
			System.out.println("Fetching records with LIKE condition...");
			sql = "Select id, firstname, lastname, age from employee" +
					" Where firstname Like '%EF%' ";
